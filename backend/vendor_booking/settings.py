"""
Django settings for vendor_booking project.
"""
...
ROOT_URLCONF = 'vendor_booking.urls'
...
WSGI_APPLICATION = 'vendor_booking.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'vendor_booking'),
