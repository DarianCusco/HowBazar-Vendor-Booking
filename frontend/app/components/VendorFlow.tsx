...
export default function VendorFlow({ onBack }: VendorFlowProps) {
  const [step, setStep] = useState<'calendar' | 'form'>('calendar');
  const [selectedDates, setSelectedDates] = useState<string[]>([]);
  const config = VENDOR_CONFIG.regular;
          ...
          >
            <div className="text-center mb-4 sm:mb-6">
              ...
              <p className="text-sm sm:text-base md:text-lg text-white/90 drop-shadow-md px-2">
                Pick one or multiple days to vend this spring
              </p>
            </div>
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                  <div className="flex items-center gap-2">
                    <div className="bg-gradient-to-r from-green-400 to-emerald-400 text-white px-3 py-1 rounded-full text-xs sm:text-sm font-medium whitespace-nowrap">
                  ...
                  {/* Clear all button - hidden on mobile if space is tight, shown in separate row */}
                  <button
                ...
                <div className="mt-4 flex justify-center">
                  <motion.button
                    ...
                    className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-green-500 to-emerald-500 text-white font-bold text-base sm:text-lg rounded-xl shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2"
                  >
